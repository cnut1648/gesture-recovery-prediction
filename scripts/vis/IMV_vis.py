...
def parse():
    ...
    parser.add_argument("--train30_test10", default=True, action='store_true')
...
train30_test10 = arg.train30_test10
k_fold = arg.k
...
OUTPUT_DIR = f"/home/jiashu/seq/artifact/IMV/{ckpt_id}"
...
with torch.no_grad():
    for i, batch in tqdm.tqdm(enumerate(dataloader), total=len(dataloader)):
        ...
        alpha = alpha.squeeze()
        # (T, 1)
        alpha = alpha.mean(1, keepdim=True)
        # (d, )
        beta = beta.squeeze()
